...
public class ReportFoundItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser == null) {
            ...
            Intent intent = new Intent(ReportFoundItemActivity.this, LoginActivity.class);
        ...
        if (cancel) {
            ...
            ApiClient.addItem(item, sessionManager.getToken(), imageBase64, new ApiClient.ApiCallback<Item>() {
                ...
                public void onSuccess(Item result) {
                    showProgress(false);
                    Toast.makeText(ReportFoundItemActivity.this, getString(R.string.success_report), Toast.LENGTH_LONG).show();
                    finish();
                }
                ...
                public void onError(String error) {
                    showProgress(false);
                    Toast.makeText(ReportFoundItemActivity.this, error, Toast.LENGTH_LONG).show();
                }
            });
        }
    }
